...
- CDN utilisé : https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js
- xlsx.read(); xlsx.utils.sheet_to_json() => convertit excel en tabler JS

Vis.js Network
- Fonction : Créer des graphes/réseaux interactifs/neural network like 
- Documentation : https://visjs.github.io/vis-network/docs/network/
- CDN utilisé : https://cdnjs.cloudflare.com/ajax/libs/vis-network/9.1.2/dist/vis-network.min.js
